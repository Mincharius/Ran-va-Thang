...
var require_colyseus = __commonJS({
  "node_modules/colyseus.js/dist/colyseus.js"(exports, module) {
    (function(global2, factory) {
        ...
        (function(global2, factory) {
          ...
          var ArraySchema = function() {
            ...
            ArraySchema2.is = function(type2) {
              return Array.isArray(type2) || type2["array"] !== void 0;
            };
            ...
            ArraySchema2.prototype.slice = function(start, end) {
              return new (ArraySchema2.bind.apply(ArraySchema2, __spreadArray([void 0], Array.from(this.$items.values()).slice(start, end), false)))();
            };
      ...
      var Room = function() {
        function Room2(name, rootSchema) {
          var _this = this;
        ...
        Object.defineProperty(Room2.prototype, "id", {
          get: function() {
            return this.roomId;
          },
          enumerable: false,
        ...
        Room2.prototype.connect = function(endpoint, devModeCloseCallback, room) {
          if (room === void 0) {
            room = this;
          }
          var connection = new Connection();
          room.connection = connection;
          connection.events.onmessage = Room2.prototype.onMessageCallback.bind(room);
        ...
        Room2.prototype.leave = function(consented) {
          var _this = this;
          if (consented === void 0) {
            consented = true;
          }
        ...
        Room2.prototype.onMessage = function(type, callback) {
          return this.onMessageHandlers.on(this.getMessageHandlerKey(type), callback);
        };
        Room2.prototype.send = function(type, message) {
        ...
        Room2.prototype.sendBytes = function(type, bytes) {
        ...
        Object.defineProperty(Room2.prototype, "state", {
          get: function() {
        ...
        Room2.prototype.removeAllListeners = function() {
          this.onJoin.clear();
        ...
        Room2.prototype.onMessageCallback = function(event) {
        ...
        Room2.prototype.setState = function(encodedState) {
          this.serializer.setState(encodedState);
          this.onStateChange.invoke(this.serializer.getState());
        };
        Room2.prototype.patch = function(binaryPatch) {
          this.serializer.patch(binaryPatch);
          this.onStateChange.invoke(this.serializer.getState());
        };
        Room2.prototype.dispatchMessage = function(type, message) {
        ...
        Room2.prototype.destroy = function() {
          if (this.serializer) {
            this.serializer.teardown();
          }
        };
        Room2.prototype.getMessageHandlerKey = function(type) {
          switch (typeof type) {
            case "function":
      ...
      var Client = function() {
        ...
        Client2.prototype.joinOrCreate = function(roomName, options, rootSchema) {
          if (options === void 0) {
            options = {};
          }
        ...
        Client2.prototype.create = function(roomName, options, rootSchema) {
          if (options === void 0) {
            options = {};
          }
          return __awaiter(this, void 0, void 0, function() {
        ...
        Client2.prototype.join = function(roomName, options, rootSchema) {
          if (options === void 0) {
            options = {};
          }
          return __awaiter(this, void 0, void 0, function() {
        ...
        Client2.prototype.joinById = function(roomId, options, rootSchema) {
          if (options === void 0) {
            options = {};
          }
          return __awaiter(this, void 0, void 0, function() {
        ...
        Client2.prototype.reconnect = function(reconnectionToken, rootSchema) {
          return __awaiter(this, void 0, void 0, function() {
        ...
        Client2.prototype.getAvailableRooms = function(roomName) {
          if (roomName === void 0) {
            roomName = "";
          }
          return __awaiter(this, void 0, void 0, function() {
        ...
        Client2.prototype.consumeSeatReservation = function(response, rootSchema, reuseRoomInstance) {
          return __awaiter(this, void 0, void 0, function() {
              ...
              room.connect(this.buildEndpoint(response.room, options), response.devMode && function() {
                return __awaiter(_this, void 0, void 0, function() {
                  ...
                  return __generator(this, function(_a3) {
                    console.info("[Colyseus devMode]: ".concat(String.fromCodePoint(128260), " Re-establishing connection with room id '").concat(room.roomId, "'..."));
                    retryCount = 0;
                    retryMaxRetries = 8;
                      ...
                      return __awaiter(_this2, void 0, void 0, function() {
                        return __generator(this, function(_a4) {
                          switch (_a4.label) {
                            ...
                            case 2:
                              _a4.sent();
                              console.info("[Colyseus devMode]: ".concat(String.fromCodePoint(9989), " Successfully re-established connection with room '").concat(room.roomId, "'"));
                              return [3, 4];
                            case 3:
                              _a4.sent();
        ...
        Client2.prototype.createMatchMakeRequest = function(method, roomName, options, rootSchema, reuseRoomInstance) {
          if (options === void 0) {
            options = {};
          }
          return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a2) {
              switch (_a2.label) {
                ...
                case 1:
                  ...
                  return [4, this.consumeSeatReservation(response, rootSchema, reuseRoomInstance)];
                case 2:
                  return [2, _a2.sent()];
              }
            });
        ...
        Client2.prototype.createRoom = function(roomName, rootSchema) {
          return new Room(roomName, rootSchema);
        };
        Client2.prototype.buildEndpoint = function(room, options) {
          if (options === void 0) {
            options = {};
          }
          var params = [];
        ...
        Client2.prototype.getHttpEndpoint = function(segments) {
          if (segments === void 0) {
            segments = "";
          }
        ...
        Client2.prototype.getEndpointPort = function() {
...
// dep:colyseus__js
var colyseus_js_default = require_colyseus();
export {
  colyseus_js_default as default
};
